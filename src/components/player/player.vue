                    ...
                    <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
                        <div class="lyric-wrapper">
                            <div v-if="currentLyric">
                                <p  v-for="(line, index) in currentLyric.lines" :key="index" class="text" ref="lyricLine" :class="{'current':currentLineNumber === index}">{{ line.txt }}</p>
                            </div> 
                        </div>
                    </scroll>
                </div>
                <div class="bottom">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <progress-bar :percent="percent" @percentChange="chagePercent"></progress-bar>
                        </div>
                    ...
                    <div class="operators">
                        ...
                        <div class="icon i-rigth" :class="disableCls">
...
export default {
    ...
    methods: {
        ...
        formatTime(interval) {
            ...
            const seconds = this._pad(interval % 60 | 0)
            return `${minutes}:${seconds}`
        },
        chagePercent(percent) {
